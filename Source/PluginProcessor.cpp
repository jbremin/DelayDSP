...
void DelayDSPAudioProcessor::setCurrentProgram (int)
{
}

const juce::String DelayDSPAudioProcessor::getProgramName (int)
{
    return {};
}

void DelayDSPAudioProcessor::changeProgramName (int, const juce::String&)
{
}
